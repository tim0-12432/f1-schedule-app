...
public class AccidentChart extends AbstractChart<BarChart> {

    private final Map<DriverStanding, Integer> data;

    public AccidentChart(Context ctx, BarChart chart, DataSet dataSet, Map<DriverStanding, Integer> data) {
