...
public class CircuitParser extends AbstractEntityParser<Circuit> {
    private static final LocationParser locationParser = new LocationParser();

    @Override
    public Circuit parse(XmlPullParser parser) throws XmlPullParserException, IOException {
            ...
            if (event == XmlPullParser.START_TAG) {
                ...
                switch (attr) {
                    case "CircuitName":
                        ...
                        break;
                    case "Location":
                        builder.withLocation(locationParser.parse(parser));
                        break;
                }
            }
