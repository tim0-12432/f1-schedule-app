...
public enum ConstructorAttr {
    ...
    ALPH("Scuderia AlphaTauri", R.color.black_charcoal, Nationality.ITALIAN, EngineConstructor.RedBull),            // Red Bull
    ...
    REDB("Red Bull Racing", R.color.blue_prussian, Nationality.AUSTRIAN, EngineConstructor.RedBull),                // Toro Rosso
