...
public enum ConstructorAttr {
    ...
    HAAS("MoneyGram Haas F1 Team", R.color.blue_yonder, Nationality.AMERICAN, EngineConstructor.Ferrari, new NonDriverPerson("Günther", "Steiner", Nationality.ITALIAN), new NonDriverPerson("Rob", "Taylor", Nationality.DEFAULT)), // Haas
    ALFA("Alfa Romeo F1 Team Stake", R.color.red_rose_vale, Nationality.SWISS, EngineConstructor.Ferrari, new NonDriverPerson("Alessandro Alunni", "Bravi", Nationality.DEFAULT), new NonDriverPerson("Jan", "Monchaux", Nationality.DEFAULT)), // Sauber
    ALPH("Scuderia AlphaTauri", R.color.black_charcoal, Nationality.ITALIAN, EngineConstructor.RedBullPowertrains, new NonDriverPerson("Franz", "Tost", Nationality.AUSTRIAN), new NonDriverPerson("Jody", "Egginton", Nationality.DEFAULT)), // Toro Rosso
    ALPI("Alpine F1 Team", R.color.purple_middle, Nationality.FRENCH, EngineConstructor.Renault, new NonDriverPerson("Otmar", "Szafnauer", Nationality.ROMANIAN), new NonDriverPerson("Matthew", "Harman", Nationality.DEFAULT)), // Renault
    ASTO("Aston Martin F1 Team", R.color.green_viridian, Nationality.BRITISH, EngineConstructor.Mercedes, new NonDriverPerson("Mike", "Krack", Nationality.DEFAULT), new NonDriverPerson("Dan", "Fallows", Nationality.DEFAULT)), // Racing Point
    WILL("Williams Racing", R.color.blue_lapis_lazuli, Nationality.BRITISH, EngineConstructor.Mercedes, new NonDriverPerson("James", "Vowles", Nationality.BRITISH)), // Williams
    ...
    REDB("Red Bull Racing", R.color.blue_prussian, Nationality.AUSTRIAN, EngineConstructor.RedBullPowertrains, new NonDriverPerson("Christian", "Horner", Nationality.BRITISH), new NonDriverPerson("Pierre", "Waché", Nationality.FRENCH)),     // RedBull
    ...
    LOTU("Lotus F1", R.color.yellow_metallic_gold, Nationality.BRITISH, EngineConstructor.Renault, new NonDriverPerson("Gerard", "Lopez", Nationality.DEFAULT)), // Lotus Renault
