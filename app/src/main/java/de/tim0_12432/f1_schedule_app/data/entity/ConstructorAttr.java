...
public enum ConstructorAttr {
    ...
    ALPH("Scuderia AlphaTauri", R.color.black_charcoal, Nationality.ITALIAN, EngineConstructor.RedBullPowertrains, new NonDriverPerson("Franz", "Tost", Nationality.AUSTRIAN), new NonDriverPerson("Jody", "Egginton", Nationality.BRITISH)), // Toro Rosso
    ALPI("Alpine F1 Team", R.color.purple_middle, Nationality.FRENCH, EngineConstructor.Renault, new NonDriverPerson("Otmar", "Szafnauer", Nationality.ROMANIAN), new NonDriverPerson("Matthew", "Harman", Nationality.BRITISH)), // Renault
